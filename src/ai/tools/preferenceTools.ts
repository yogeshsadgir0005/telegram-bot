...
registerTool({
  ...
  parameters: {
    ...
    properties: {
      ...
      dayOfWeek: { type: "number", description: "0=Sunday..6=Saturday. Only applies to weeklyDigest." },
    },
    required: ["key"],
  },
  execute: async (args: { key: string; enabled?: boolean; time?: string; dayOfWeek?: number }, ctx) => {
    ...
    if (args.dayOfWeek !== undefined && args.key === "weeklyDigest") set[`notifications.weeklyDigest.dayOfWeek`] = args.dayOfWeek;
